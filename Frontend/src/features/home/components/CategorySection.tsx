  ...
  return (
    <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 min-w-0 w-full">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3 sm:gap-6 min-w-0 reveal">
            {[
                ...
                className={`group flex flex-col items-center justify-center p-4 sm:p-8 min-w-0 bg-cream rounded-3xl hover:bg-lightrose/50 hover:-translate-y-2 hover:shadow-card transition-all duration-300 border border-transparent hover:border-lightrose ${cat.hidden ? 'hidden md:flex' : ''}`}
                >
